...
![과제3 실행화면](img/3.png)
![과제3-1 실행화면](img/3-1.png)

- 과제 내용
  - 키보드 주문 추가
  - 탭키 이동 우선순위 배정
- 구현 내용과 기능 설명
  - 탭키를 통한 이동이 필요없는 리스트박스같은 요소는 Tapstop을 false로 하여 불필요한 이동을 막음
  - VS 내 보기-탭 순서 설정을 통하여 이동 우선순위 부여함
  - Form1 내의 Acceptbutton을 orderbutton과 연결하고 keycode를 배정하여 enter 키로 주문하기 버튼이 되도록 함
...
- 과제 내용
  - 메뉴 실시간 반영
- 구현 내용과 기능 설명
  - 기존의 주문하기 로직을 radio버튼 및 checkbox에 "CheckedChanged" 이벤트에 씌우고 적절히 변형하여 실시간으로 가격이 업데이트되게 설정함
